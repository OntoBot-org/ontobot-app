    ...
    return (
        <div className="w-full mt-24 text-fontcolor">
            ...
            <p className="font-semibold text-primary text-center my-2">
                Please note that OntoBot populates ONLY the ontologies that are created using OntoBot.
            </p>
            <p className="font-normal">
                As you created the ontology and dowloaded the OWL file, OntoBot gave you a <span className="font-semibold text-secondary">unique id</span> for your ontology. We
                even adviced you to copy it as it is required for the population.
                First, enter the <span className="font-semibold text-secondary">ontology id</span>. 
                <br></br>
                If you want to generate the <span className="font-semibold text-secondary">excel sheet </span> related to your ontology, click <span className="font-semibold text-secondary">Generate Excel Sheet</span>.
                <br></br>
                If you already have <span className="font-semibold text-secondary">completed</span> your excel sheet, click <span className="font-semibold text-secondary">Upload Excel Sheet</span>.
            </p>
                ...
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center gap-4">
                        ...
                        <input
                            ...
                            value={excelsheetId}
                            onChange={(e) =>
                                setexcelsheetId(e.target.value )
                            }
                        />
                    </div>
...

            {
                isUpload && (
                    <div>
                        <p className="mt-8 mb-2 modal_title flex items-start">The excel sheet is already filled?</p>
