				...
				<div className="flex mt-1">
					<div id="navbar-sticky">
						<ul className="flex space-x-5">
							<li>
								<Link to="/try-ontobot" className="nav_li" aria-current="page">
									Create Ontology
								</Link>
							</li>
							<li>
								<Link
									to="/populate-ontology"
									className="nav_li"
									aria-current="page"
								>
									Populate Ontology
							...
							<li>
								<Link to="/vocabulary" className="nav_li" aria-current="page">
									Vocabulary
								</Link>
							</li>
							<li>
								<Link to="/about" className="nav_li" aria-current="page">
									About
								</Link>
							</li>
						</ul>
